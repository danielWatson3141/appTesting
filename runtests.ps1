...
$outputDir = $args[6] #Trepn directory on Android device 
$trepnPath = "sdcard/trepn"

#Use default path if none provided.
$trepnPath =if(!$outputDir) { -join($trepnPath,"/",$outputFile,".csv") } else { -join($outputDir,"/",$outputFile,".csv")}
...
#load prefs
starfish devices control $target shell am broadcast -a com.quicinc.trepn.load_preferences -e com.quicinc.trepn.load_preferences_file "/trepn/saved_preferences/expPrefs.pref"
Start-Sleep -s 1
